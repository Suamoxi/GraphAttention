...
| Explicit AVBP snapshot-to-mesh association | Project data/provenance contract | `docs/M3_2_AVBP_HDF5.md` | `AVBPSampleSpec`, `AVBPHDF5Dataset.sample_specs` | `tests/unit/test_avbp_hdf5.py` | Implemented M3.2; real-file validation pending |
